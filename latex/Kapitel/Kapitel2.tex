...
\hline
1 & \url{www.raspiprojekt.de} & 35001 & \RPi\ Modell B+\\
\hline
...
Die hier beschriebene Umsetzung ist lediglich als Anregung zu verstehen: Wegen
der geplanten Anwendung auf einem Faschingswagen wurde hier ganz bewusst auf
eine massive Bauweise mit einem stabilen Holzrahmen und einem industriellen
Touchpanel als Front gesetzt. Das Innenleben (\RPi\ etc.) konnte dann
relativ problemlos eingebaut werden.\\
...
Maus für die Bedienung benutzt werden.

Nachdem zunächst geplant war, eine 230V-Stromversorgung über ein am Bulldog
angeschlossenes Zapfwellenaggregat herzustellen und mit großen Verstärkern zu
...
sich falsch herum dreht... Saugefährlich! Daher schaltete bei unserem Aggregat
die Sicherungseinrichtung ab. \smiley{nosmile} Ein Anschluss des Aggregates an
der Hinterseite des Bulldogs fiel aus, da ja dort der Faschingswagen hängt und
...
Watt. Deshalb auch die für manchen Leser wohl relativ chaotische und
undurchdachte Spannungsversorgung im RPi-Touchpanel. Anschließend noch drei
...
Wenn die folgenden Punkte umgesetzt würden, könnte der ganze Aufbau sogar noch
gut werden!
\end{bclogo}
...
Die im vorherigen Punkt vorgeschlagene Mikrocontrollerschaltung könnte so
erweitert werden, dass beim Ausschalten die Stromversorgung zum \RPi\ erst dann
 getrennt wird, wenn dieser vollständig heruntergefahren ist. Alternativ wäre
der Einbau einer USV für den \RPi\ noch eine Option, siehe
\url{http://www.piusv.de} oder \url{http://www.s-usv.de}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{RPi_YAMuPlay_Frontansicht.JPG}
