...
die zur Ausführung von \Bezeichnung\ erforderlich sind. \textbf{Bitte jetzt
noch nicht die in der Spalte "`Quelle"' angegebenen Download-Kommandos
ausführen!}  Sie dienen nur dem vorläufigen Überblick. Eine
Schritt-für-Schritt-Anleitung erfolgt im folgenden Kapitel \ref{sect:Install}.
\end{bclogo}
...
\item \textbf{Kernel- und Broadcom-Firmware-Update durchführen}\\
      ...
      ursprünglichen \textit{wheezy}-Installation erforderlich. Beim aktuellen
      ...
      verursachen und sollte möglichst vermieden werden.
      \end{bclogo}
